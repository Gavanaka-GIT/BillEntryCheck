      ...
      if (response.statusCode == 200) {
        ...
        if(data['valid']){
          ...
          for(int i=0; i<getSupplierName.length;i++){
            supplierList.add(getSupplierName[i]['Supplier'].toString().toLowerCase());
          }
  ...
  void initState() {
    ...
    if(updVal["approve"]){
      ...
      setState(() {
        ...
        groupId = selectedData['values']['LedgerGroupId'].toString()=="null"?"":selectedData['values']['LedgerGroupId'].toString();
                          ...
                          Flexible(
                              ...
                              Padding(
                                ...
                                Card(elevation: 5,
                                  ...
                                  child:
                                  DropdownSearch(
                                    items: (filter, infiniteScrollProps)=>groupList,
                          ...
                          Expanded(
                            ...
                            Padding(
                              ...
                              Card(elevation: 5,
                                ...
                                child:
                                DropdownSearch(
                                  items: (filter, infiniteScrollProps)=>cityList,
                                  onChanged: (dynamic newValue){
                          ...
                          Flexible(
                            ...
                            child: Padding(
                              ...
                              child:Card(elevation: 5,
                                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                                  child:
                                  Container(// Add padding for the dropdown
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(10),
                                      border: Border.all(color: Colors.grey), // Border style for the dropdown
                                    ),child:
                                  DropdownButton(
                                      value: openingBalanceSuffixVar,
                                      items: openingBalanceSuffix.map((String value){
                                        return DropdownMenuItem(value: value,child: Text(value));
                                      }).toList(), onChanged: (String? newValue){
                                    setState(() {
                                      openingBalanceSuffixVar=newValue.toString();
                                    });
                                ...
                                onPressed: () {
                                  if (_formKey.currentState!.validate()) {
                                    ...
                                    dynamic value= {
                                      ...
                                      "TNGST_No" : gstNumberController.text,
                                      "TIN_No": msmeController.text, //check
